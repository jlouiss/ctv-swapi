...
13. As a TV viewer browsing Vehicles or Starships, I want to see Name, Model, Manufacturer, Cost in credits, Length, Crew, Passengers, and Cargo capacity directly on each item's tile, so that I can compare transportation options without opening each one individually.
